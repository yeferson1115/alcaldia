$(document).ready(function(){
  ...
  $('#main-form').submit(function(){
      ...
      if ($('#main-form #name').val() === '') {
          $('#main-form #name_alert').text('Ingrese el Nombre del estudiante').show();
          $('#main-form #name').focus();
          return false;
      }
      if ($('#main-form #last_name').val() === '') {
          $('#main-form #last_name_alert').text('Ingrese el apellido del estudiante').show();
      ...
      if ($('#main-form #document').val() === '') {
          $('#main-form #document_alert').text('Ingrese el número de documento del estudiante').show();

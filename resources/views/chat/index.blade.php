            ...
            $.get('/chat/active', function(chats) {
                ...
                chats.forEach(chat => {
                    ...
                    if(chat.status==="pendiente"){
                        clase="avatar-offline";
                    }
                    $('#chat-list').append(`
                        <li class="chat-contact-list-item mb-0" onclick="loadMessages(${chat.id})">                           
                        <a class="d-flex align-items-center">
                            <div class="flex-shrink-0 avatar ${clase}">
                              <span class="avatar-initial rounded-circle bg-label-success">Chat</span>
                            </div>
                            <div class="chat-contact-info flex-grow-1 ms-4">
                              <div class="d-flex justify-content-between align-items-center">
                                <h6 class="chat-contact-name text-truncate fw-normal m-0">Chat #${chat.id}</h6>

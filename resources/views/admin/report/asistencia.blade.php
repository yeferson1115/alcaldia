...
<div class="content-header row mt-5">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Reporte</h2>
                            ...
                            <table class="table" id="yajra-datatable" >
                                <thead class="table-light">
                                    <tr >
                                        ...
                                        <th class="sorting" >Fecha y Hora</th>
            ...
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {
                    ...
                    render: function (data, type, full, meta) {
                        if(data==1){
                            return '<span class="badge  text-white bg-success">Ingreso</span>';
                        }
                        if(data==0){
                            return '<span class="badge  text-white bg-danger">Salida</span>';
                        }
                ...
                {data: 'area', name: 'area'},
                {data: 'empleado.charge.name', name: 'cargo'},
                {
                    name: "created_at",
                    data: "created_at",
                    render: function (data, type, full, meta) {
                        return '<label>'+moment(data).format('YYYY-MM-DD HH:mm:ss')+'</label>';
                    },
                    "orderable": true,
                    "searchable": true
                },
                {data: 'empleado.city', name: 'city'},
            ],
            "language": {
